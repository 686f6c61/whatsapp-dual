...
wget https://github.com/686f6c61/whatsapp-dual/releases/latest/download/whatsapp-dual_1.5.1_amd64.deb

# Install the package
sudo dpkg -i whatsapp-dual_1.5.1_amd64.deb
...
wget https://github.com/686f6c61/whatsapp-dual/releases/latest/download/WhatsAppDual-1.5.1-x86_64.AppImage

# Make it executable
chmod +x WhatsAppDual-1.5.1-x86_64.AppImage

# Run the application
./WhatsAppDual-1.5.1-x86_64.AppImage
```
